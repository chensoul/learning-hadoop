...
public class BlobStoreTest {
  ...
  private static String tableName = "blob5";
  ...
  public static void main(String[] agrs) {
    ...
    try {
      ...
      hba.createTable(Configure.genHTableDescriptor(tableName, (short) 4, true));
      ...
      for (int i = 1; i < 100000000; i++) {
        ...
        put.add(Bytes.toBytes(Configure.FAMILY_NAME), Bytes.toBytes("key"),
            Bytes.toBytes(i + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
        table.put(put);
      }
